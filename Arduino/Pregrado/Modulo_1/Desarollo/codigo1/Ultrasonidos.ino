...
bool ultrasonidoConectadoI = false;
bool ultrasonidoConectadoF = false;
bool ultrasonidoConectadoD = false;
...
void InformarEstadoConexionSensoresDistanciaI(){
  if(ultrasonidoConectadoI){
    Serial.println("Sensor Distancia Izquierdo Conectado");
  }else{
    Serial.println("Sensor Distancia Izquierdo Desconectado");
  }
}

void InformarEstadoConexionSensoresDistanciaF(){
  if(ultrasonidoConectadoF){
    Serial.println("Sensor Distancia Frontal Conectado");
  }else{
    Serial.println("Sensor Distancia Frontal Desconectado");
  }
}

void InformarEstadoConexionSensoresDistanciaD(){
  if(ultrasonidoConectadoD){
    Serial.println("Sensor Distancia Derecho Conectado");
  }else{
    Serial.println("Sensor Distancia Derecho Desconectado");
  }
}
