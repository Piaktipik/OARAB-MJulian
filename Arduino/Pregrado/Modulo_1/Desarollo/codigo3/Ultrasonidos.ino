...
int dist_maxi_fron = 100;       // distancia maxima frontal, seguidor
int dist_mini_fron = 50;       // distancia minima frontal 
int dist_mini_late = 30;       // distancia minima lateral
int dist_maxi_late = 100;       // distancia maxima lateral, seguidor
...
void activarRadares(bool activarRadar = true){
  if(!servoI.attached()){
  ...
  radarActivado = activarRadar;
}

void desactivarRadares(){
  if(servoI.attached()){
    servoI.detach();
    digitalWrite(7,LOW);
    limpiarMedidasRadarI();
